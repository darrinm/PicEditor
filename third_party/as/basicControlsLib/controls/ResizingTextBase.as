...
include "../../../flex_sdk_3_2/frameworks/projects/framework/src/mx/styles/metadata/LeadingStyle.as"
 ...
 */
public class ResizingTextBase extends Label
{
    ...
    */
     ...
     *  Constructor.
     */
    public function ResizingTextBase()
    {
        super();
       ...
       // Allow a minimum text size of 0 so we can effectively hide a label
       // as one of our states.
                                                  ...
                                                  unscaledHeight:Number):void
    {
        ...
        textField.setActualSize(unscaledWidth - paddingLeft - paddingRight - UITextField.TEXT_WIDTH_PADDING,
    ...
    private function measureUsingWidth(w:Number):void
    {
        ...
        */
        ...
        if (!isNaN(w))
        {
            textField.width = w - paddingLeft - paddingRight - UITextField.TEXT_WIDTH_PADDING;
