...
package imagine.imageOperations {
	...
	import imagine.imageOperations.engine.instructions.SetVarInstruction;
	
	[RemoteClass]
	public class SetVar extends BlendImageOperation {
		private var _strName:String;
		
		public function SetVar(strName:String=null) {
			_strName = strName;
		}
		...
		override public function Compile(ainst:Array):void {
			ainst.push(new SetVarInstruction(_strName));
		}
		...
		override public function Deserialize(xmlOp:XML): Boolean {
			Debug.Assert(xmlOp.@varName, "SetVar varName argument missing");
			_strName = xmlOp.@varName;
			return true;
		}
		
		override public function Serialize(): XML {
			return <SetVar varName={_strName}/>
		}
	}
}
