...
package imagine.imageOperations
{
	...
	[RemoteClass]
	public class CirclesTiledImageMask extends TiledImageMask
	{
		public function CirclesTiledImageMask(rcBounds:Rectangle = null) {
			super(rcBounds);
		}
		...
		override protected function generateTileMask(): BitmapData {
			...
			var acoColors:Array = [0,0,0,0];
			var anAlphas:Array = [_alphaMin,_alphaMax,_alphaMin,_alphaMin,];
			var anRatios:Array = [0,200,210,255];
		...
		override protected function getTileMask(): BitmapData {
			var bmdTileMask:BitmapData = BitmapCache.Lookup(this, "CirclesTiledImageMask", calcTileMaskKey(), null);
			if (!bmdTileMask) {
				bmdTileMask = generateTileMask();
				BitmapCache.Set(this, "CirclesTiledImageMask", calcTileMaskKey(), null, bmdTileMask);
			}
			return bmdTileMask;
		}				
	}
