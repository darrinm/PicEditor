...
package imagine.documentObjects {
	...
	public interface IDocumentObject extends IDocumentSerializable, IDocumentStatus { // doco
		...
		function FilterMenuItems(aobItems:Array):Array;
	
		function get isFixed(): Boolean;

		// Whether or not the object palette should be shown when the object is selected
		function get showObjectPalette(): Boolean;
		function set showObjectPalette(f:Boolean): void;
		...
		// The class for a suitable controller for this object
		function get controller(): Class;
		function set controller(cls:Class): void;
	}
}
