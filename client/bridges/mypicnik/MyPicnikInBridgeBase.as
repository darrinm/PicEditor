...
package bridges.mypicnik {
	...
	public class MyPicnikInBridgeBase extends StorageServiceInBridgeBase {
   		[ResourceBundle("MyPicnikInBridge")] private var _rb:ResourceBundle;
   		
		public function MyPicnikInBridgeBase() {
			super();
