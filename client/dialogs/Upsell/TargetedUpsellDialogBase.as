...
package dialogs.Upsell
{
	...
	public class TargetedUpsellDialogBase extends CloudyResizingDialog
	{
		...
		protected function ShowPaymentSelector(): void {
			super.Hide();
			DialogManager.ShowUpgrade(_strSourceEvent, _uicParent, _fnComplete, _obDefaults);
		}
		...
		public function SetParams(strSourceEvent:String, uicParent:UIComponent=null, fnComplete:Function=null, obDefaults:Object=null): void {
			_strSourceEvent = strSourceEvent;
			_uicParent = uicParent;
			_fnComplete = fnComplete;
			_obDefaults = obDefaults;
			
			if (_obDefaults && 'fFirstRun' in _obDefaults)
				firstRunMode = _obDefaults.fFirstRun;
