...
package dialogs
{
	...
	public class CloudyResizingDialog extends ResizingDialog
	{
		...
		protected function ShowBusy(strMsg:String = null): void {
			if (!strMsg) {
				strMsg = Resource.getString('OrderTab', 'processing');
			}
