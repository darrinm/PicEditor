...
function awstats_detectIE(TRKClassID) {
	...
	// DWM: this makes IE7 barf up a cryptic message at the top of the screen.
	// We'd rather keep our UX good than gather these stats.
...
if (window.location.search == "" || window.location.search == "?") {
	...
	var imgsrc2 = '&shk='+TRKshk+'&svg='+TRKsvg+'&fla='+TRKfla+'&rp='+TRKrp+'&wma='+TRKwma+'&pdf='+TRKpdf+'&uid='+TRKuserid+'&sid='+TRKsessionid;
    //alert(imgsrc1);
    //alert(imgsrc2);
